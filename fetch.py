        ...
        for comp in cal.walk():
            ...
            if team.startswith('nascar'):
                ...
                if 'cup' in blob:
                    ...
                    actual_team = 'nascar_cup'
                # Private calendar has all 3 series; skip Cup/Truck events
                # since those are already covered by their public calendars
                if team == 'nascar_ore' and actual_team != 'nascar_ore':
                    continue
